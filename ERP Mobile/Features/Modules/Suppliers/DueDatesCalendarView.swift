...
struct DueDatesCalendarView: View {
    let days: [DueDateCalendarDay]
    let onSelectSupplier: (DueDateCalendarSupplierRow) -> Void

    @State private var selectedDay: DueDateCalendarDay?
    ...
    var body: some View {
        ...
        .sheet(item: $selectedDay) { day in
            DueDateCalendarDayDetailSheet(day: day, onSelectSupplier: onSelectSupplier)
        }
    }
...
private struct DueDateCalendarDayCell: View {
    let day: DueDateCalendarDay
    let isToday: Bool
    let onTap: () -> Void
...
private struct DueDateCalendarDayDetailSheet: View {
    let day: DueDateCalendarDay
    let onSelectSupplier: (DueDateCalendarSupplierRow) -> Void
    ...
    var body: some View {
        NavigationView {
            List {
                ...
                Section {
                    ForEach(day.supplierRows) { row in
                        Button {
